  ...
  return (
    <Contain width="80%">
      <HeadThree
        ...
        margin="2rem 0 2rem 0"
      >
        We Don't Have That Food Yet
      </HeadThree>

      <Paragraph fontSize="1.8rem" margin="0 0 2rem 0" lineHeight="2.4rem">
        Unforunately we have not added that food to our database yet. We will make sure to add it to a list of items that
        need to be added. Please check back at a later time.
      </Paragraph>
    </Contain>
  );
}
